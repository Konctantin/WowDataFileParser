...
namespace Kamilla.IO
{
    ...
    public class StreamHandler : IDisposable
    {
        ...
        //    int uncompressedLength = this.ReadInt32();
        //    if (uncompressedLength == 0)
        //        return new StreamHandler(new byte[0]);

        //    this.Skip(2);
        //    byte[] compressedBytes = this.ReadBytes((int)this.RemainingLength);
        ...
        //    value = this.UnalignedReadBit() ? (byte)1 : (byte)0;
        ...
        {
            return PascalStringReader(this, this.ReadInt32());
        }

        public /*static*/ string ReadPascalString16(/*this StreamHandler sh*/)
        {
            return PascalStringReader(this, this.ReadUInt16());
        }

        public /*static*/ string ReadPascalString16Wdb(/*this StreamHandler sh*/)
        {
            var v1 = this.UnalignedReadInt(8);
            var v2 = this.UnalignedReadInt(4);
            var len = 16 * v1 | v2;
            return PascalStringReader(this, (int)len-1);
        }

        public /*static*/ string ReadPascalString8(/*this StreamHandler sh*/)
        {
            return PascalStringReader(this, this.ReadByte());
        }
